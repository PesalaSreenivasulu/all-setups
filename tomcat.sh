...
wget https://dlcdn.apache.org/tomcat/tomcat-9/v9.0.107/bin/apache-tomcat-9.0.105.tar.gz
tar -zxvf apache-tomcat-9.0.175.tar.gz
...
sed -i '58  a\<user username="tomcat" password="123" roles="manager-gui, manager-script"/>' apache-tomcat-9.0.107/conf/tomcat-users.xml
